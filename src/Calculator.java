...
public class Calculator {
	...
	public double getFoodGHGEmission(String name, Double weight) {
		...
		double emission = readData.get(name.toLowerCase()).getCarbonEmissions() * weight;
		return emission;
	}
	 ...
	 * 
	 * @param the user input food name
	 * @return an Arraylist contains three other food in the same category, sorted
	 *         by GHG. If database doesn't have enough food in same category with
	 *         lower GHG, randomly select some food in same category and add them in
	 *         the Arraylist
	 */
